...
:::
:::success
- **Phase 3**: Comprehensive security audits and performance optimization
:::
:::note
- **Phase 4**: Production release with developer tooling and documentation
:::
...
> Learn more about the benefits this brings to developers in [Why It Matters](/why-it-matters).
## Join the Ecosystem
...
> Get started with integration by following our [Getting Started](/getting-started) guide or learn about the [Prerequisites](/prerequisites) needed for development.