...
## Setup
1. Deploy the L1 contract using the Address of the [World ID Manager](https://docs.world.org/world-id/reference/address-book), a temporary L2 address (ie. 1), and the address of the [Starknet Sequencer - Core Contract](https://docs.starknet.io/tools/important-addresses/)
...
## Sepolia Test 
L1 address: https://sepolia.etherscan.io/address/0xb6455FCb8e092aB70C7195709AbF3832ff9a6F34

L2 address: https://sepolia.starkscan.co/contract/0x05d5fbb9d968eb019d9066dd5a92d589fc56f0f45b9301afd3a29b3b79476dd3#transactions
