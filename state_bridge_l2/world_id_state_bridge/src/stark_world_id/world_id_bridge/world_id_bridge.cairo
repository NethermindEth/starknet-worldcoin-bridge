...
pub mod WorldID {
    ...
    use starknet::{SyscallResultTrait, get_block_timestamp};
    use world_id_state_bridge::stark_world_id::world_id_bridge::groth16_verifier_constants::{
        N_PUBLIC_INPUTS, ic, precomputed_lines, vk,
    };
    ...
    pub mod Errors {
        ...
        /// @notice Emitted if the latest root is requested but the bridge has not seen any roots
        /// yet.
    ...
    > of super::IWorldIDExt<ComponentState<TContractState>> {
    ...
    impl WorldIDVerify<
        TContractState, +HasComponent<TContractState>,
    > of interface_world_id::IGroth16VerifierBN254<ComponentState<TContractState>> {
        ///////////////////////////////////////////////////////////////////////////////
        ///                             SEMAPHORE PROOFS                            ///
        ///////////////////////////////////////////////////////////////////////////////
        ...
        /// # Returns
        ///
        /// Either panics or returns None on failure or succeeds and returns the public inputs on
        /// verification
        ///
        /// # Notice
        ///
    ...
    > of InternalTrait<TContractState> {
        ...
        fn _set_root_history_expiry(
            ref self: ComponentState<TContractState>, expiry_time: felt252,
        ) {
