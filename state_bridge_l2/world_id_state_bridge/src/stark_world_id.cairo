...
pub mod StarkWorldID {
    ...
    component!(
        path: CrossDomainOwnable,
        storage: cross_domain_ownable_storage,
        event: CrossDomainOwnableEvent,
    );
    ...
    #[l1_handler]
    pub fn set_root_history_expiry(
        ref self: ContractState, from_address: felt252, expiry_time: felt252,
    ) {
        self.cross_domain_ownable_storage.only_cross_domain_owner(from_address);
